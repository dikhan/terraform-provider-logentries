...
type checkExists func(client insight.InsightClient, id string) error

func labelExists() checkExists {
	return func(client insight.InsightClient, id string) error {
...
func checkDestroy(resourceStateId string, checkExists checkExists) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		client := testAccProvider.Meta().(insight.InsightClient)
		if len(s.Modules) != 0 {
